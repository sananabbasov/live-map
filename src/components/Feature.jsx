    ...
    return (
        <div class="bg-[#F7F7F7] text-[#333] font-[sans-serif]">
            <div class="max-w-6xl mx-auto py-16 px-4">
                <h2 class="text-4xl font-extrabold text-center mb-16">Discover Our Exclusive Features for Wildfire Management</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 max-md:max-w-md mx-auto">
                    <div class="bg-white rounded-lg overflow-hidden shadow-lg">
                        <div class="p-6">
                            ...
                            <h3 class="text-xl font-semibold mb-2">Customization for Wildfire Management</h3>
                            <p class="text-gray-500 text-sm">Tailor our product to suit your specific wildfire management needs. Customize it to effectively handle wildfires in your area.</p>
                        </div>
                    </div>
                    <div class="bg-white rounded-lg overflow-hidden shadow-lg">
                        <div class="p-6">
                            ...
                            <h3 class="text-xl font-semibold mb-2">Enhanced Security for Wildfire Data</h3>
                            <p class="text-gray-500 text-sm">Rest assured that your critical wildfire data is protected by the latest security measures. Your wildfire information is safe with us.</p>
                        </div>
                    </div>
                    <div class="bg-white rounded-lg overflow-hidden shadow-lg">
                        <div class="p-6">
                            ...
                            <h3 class="text-xl font-semibold mb-2">Optimized Performance for Wildfire Response</h3>
                            <p class="text-gray-500 text-sm">Experience lightning-fast performance with our product, ensuring quick and efficient wildfire response and management.</p>
                        </div>
                    </div>
                </div>
            </div>
